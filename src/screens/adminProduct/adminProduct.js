...
export default function Dashboard()
{
    ...
    return (<>
            ...
            <Grid item xs={12} md={12} lg={12}>
                <Paper>
                    <Grid container justifyContent="space-between">
                        ...
                        <FormControlLabel
                            control={<Switch size="medium" checked={checked} onChange={handleChange} />}
                            label="Add New Product"
                        />
                    </Grid>
                    <DataGridManagerProduct handleChangeModal={handleChangeModal} />
                </Paper>
            </Grid>
            <Grid item xs={12} md={12} lg={12}>
                <Collapse in={checked}>
        ...
        >
            <Paper style={{ width: "60%", margin: "10% auto" }}>
                <Grid item xs={12} md={12} lg={12}>
                    <FormAdd action="edit" />
                </Grid>
            </Paper>
