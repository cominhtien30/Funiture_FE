...
const DataGridProduct = ({ theme, handleChangeModal }) =>
{
    ...
    const cellAction = (id) =>
    {
        ...
        return <div className="d-flex justify-content-between">
            <a onClick={() => handleChangeModal(true)} href="#javasctipt()" style={{ color: "green", margin: "0 5px" }}><i className="fa fa-eye"></i></a>
            <a href="#javasctipt()" style={{ color: "red", margin: "0 5px" }}><i className="fa fa-trash"></i></a>
        </div>
    }
    ...
    const CustomNoRowsOverlay = () =>
    {
        return <GridOverlay>
            <div className="d-flex  mb-4 flex-column justify-content-between" >
                <img src={none} />
                <h4 className="mt-3" style={{ color: props.theme.palette.primary.title }}>Product Empty</h4>
            </div>
        </GridOverlay>
    }
